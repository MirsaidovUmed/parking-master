    ...
    <div class="bg-secondary text-center rounded p-4">
        ...
        <div class="table-responsive">
            <table class="table text-start align-middle table-bordered table-hover mb-0">
                ...
                <tr class="text-white">
                    ...
                    <th>Статус</th>
                    <th>
                        <input type="checkbox" id="selectAll" onclick="document.querySelectorAll('.row-check').forEach(cb=>cb.checked=this.checked)" />
                    </th>
                    <th>Действия</th>
                </tr>
                </thead>
        ...
        <div class="mt-3 d-flex gap-2">
            ...
            <form id="bulkCloseForm" method="POST" action="{{ route('barriers.bulk') }}">
                ...
                <button type="button" class="btn btn-secondary" onclick="submitBulk('close')">Закрыть выбранные</button>
            </form>
