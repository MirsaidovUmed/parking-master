...
!function (t, e) {
    ...
    }), Ke = (A.mergeOptions({zoomControl: !0}), A.addInitHook(function () {
    ...
    })), Bi = (A.mergeOptions({closePopupOnClick: !0}), A.include({
    ...
    qi.create = Vi, qi.pointsToPath = dt, xi.geometryToLayer = wi, xi.coordsToLatLng = Pi, xi.coordsToLatLngs = Li, xi.latLngToCoords = Ti, xi.latLngsToCoords = Mi, xi.getFeature = zi, xi.asFeature = Ci, A.mergeOptions({boxZoom: !0});
    var _t = n.extend({
            initialize: function (t) {
